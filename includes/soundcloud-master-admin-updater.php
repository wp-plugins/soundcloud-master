...
//MULTISITE TABLE
if (is_multisite()){
if(!class_exists('soundcloud_master_admin_updater_multisite')){
	require_once( dirname( __FILE__ ) . '/soundcloud-master-admin-updater-multisite-table.php');
}
//Prepare Table of elements
$wp_list_table = new soundcloud_master_admin_updater_multisite_table();
//Table of elements
...
if( is_multisite() ) {
add_action( 'network_admin_menu', 'menu_single_soundcloud_admin_updater' );
