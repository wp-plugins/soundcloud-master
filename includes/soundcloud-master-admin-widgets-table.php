...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-buttons-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-dashboard-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
			<td class="column-columnname"style="vertical-align:middle"><h3>Administrator Dashboard Widget</h3><p>Cool player widget to listen to your favourite Soundcloud Tracks while working on your Wordpress Administrator. Check Add-ons page.</p></td>
		</tr>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-profile-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
			<td class="column-columnname"style="vertical-align:middle"><h3>Soundcloud User Profile Widget</h3><p>Fast loading widget to display the Soundcloud User Profiles. A great way to connect people to your Soundcloud Profile, show off your work, sell it, gather followers and likes.</p><p>Check Add-ons page.</p></td>
		</tr>
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-basic-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('images/techgasp-soundcloudmaster-widget-advanced-admin.png', dirname(__FILE__)); ?>" alt="<?php echo get_option('soundcloud_master_name'); ?>" align="left" width="300px" height="135px" style="padding:5px;"/></td>
