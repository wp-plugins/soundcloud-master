...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-soundcloudmaster-widget-buttons-admin.png', __FILE__); ?>" alt="Soundcloud Master" align="left" width="300px" height="135px" style="padding:5px;"/></td>
		...
		<tr>
			<td class="column-columnname" width="300" style="vertical-align:middle"><img src="<?php echo plugins_url('../images/techgasp-soundcloudmaster-widget-basic-admin.png', __FILE__); ?>" alt="Soundcloud Master" align="left" width="300px" height="135px" style="padding:5px;"/></td>
