...
<table class="widefat fixed" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td class="column-columnname" width="600"><img src="<?php echo plugins_url('../images/techgasp-soundcloud-master-backend-edit.png', __FILE__); ?>" alt="Soundcloud Master" align="left" width="600px" height="265px" style="padding:5px;"/></td>
